...
CodeMirror.defineSimpleMode("minsc",{
  start: [
    ...
    {regex: /[a-f0-9]{40,130}|([xt]pub[0-9a-zA-Z]{100,120})/, token: "number"},
    ...
    {regex: /(pk|older|after|(sha|hash)256|(ripemd|hash)160|any|all|prob|wsh|wpkh|sh|miniscript|address)\b/, token: "builtin"},
